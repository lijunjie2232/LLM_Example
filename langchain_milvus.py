...
fastapi_documents = pickle.load(open("fastapi_documents.pkl", "rb"))

VCDB_URI = "./milvus_example.db"

embeddings = OllamaEmbeddings(model=EMBEDDING_MODEL)

text_splitter = RecursiveCharacterTextSplitter(chunk_size=2048, chunk_overlap=0)

all_splits = text_splitter.split_documents(fastapi_documents)

connection_args = {"uri": VCDB_URI}

COLLECTION_NAME = "FastAPIDocs"
